    ...
    <div className="position-page">
        <div className="position-content-section">
          <div className="position-content">
            ...
            <p className="position-text">1.4 Чемпионат проводится ежегодно 1 по 17 апреля, начиная с 2018 года. Прием заявок осуществляется ежегодно с 15 по 31 марта.</p>
            
            <h2 className="position-title">2. Участники Чемпионата</h2>
            <p className="position-text">2.1. В Чемпионате могут принимать участие IT-специалисты со всех стран СНГ с опытом работы не менее 3 лет.</p>
