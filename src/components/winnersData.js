const winnersData = {
      2018: [
      {
        ...
        name: "Линар Молотов",
        country: "Россия",
        project: "DataSight – интеллектуальная платформа прогнозной аналитики",
        achievements: "Линар Молотов разработал передовую платформу DataSight, основанную на алгоритмах машинного обучения и интеллектуальной визуализации данных. Это решение открыло новые возможности для автоматизированного анализа информации, позволив компаниям эффективно агрегировать данные из множества источников, выявлять скрытые закономерности и точно прогнозировать ключевые бизнес-показатели."
      },
      {
        category: "Лучший специалист по базам данных (Best Database Specialist)",
        name: "Мария Ковальчук",
        country: "Украина",
        project: "Интеллектуальная система распределенных баз данных",
        achievements: "Мария разработала алгоритм оптимизации распределённых баз данных, позволяющий ускорить обработку запросов на 40%. Её проект был внедрён в крупнейших банковских системах Украины, обеспечивая высокую надёжность и отказоустойчивость."
      },
      {
        category: "Лидер в области кибербезопасности (Cybersecurity Leader)",
        name: "Алексей Романов",
        country: "Россия",
        project: "Система анализа угроз на основе машинного обучения",
        achievements: "Алексей создал уникальную систему, которая анализирует потенциальные киберугрозы и предугадывает атаки на основе паттернов поведения. Его технология используется в корпоративном секторе для предотвращения утечек данных и защиты критически важных систем."
      },
      {
        category: "Лидер в разработке мобильных приложений (Mobile App Development Leader)",
        name: "Данияр Наргизов",
        country: "Казахстан",
        project: "Мобильное приложение для умного города",
        achievements: "Данияр разработал инновационное приложение, интегрирующееся с инфраструктурой умного города. Оно позволяет пользователям получать актуальные данные о транспорте, экологии и коммунальных услугах в режиме реального времени."
      },
      {
        category: "Лучший командный проект (Best Team Project)",
        teamName: "Future Coders",
        country: "Узбекистан",
        project: "Автоматизированная платформа для цифровой трансформации бизнеса",
        captain: "Султан Алишеров",
        members: ["Наргиза Юлдашева", "Тимур Беков", "Азиз Ахмедов", "Малика Саидова"],
        achievements: "Команда Future Coders разработала платформу, которая позволяет предприятиям малого и среднего бизнеса интегрировать цифровые решения без необходимости глубоких технических знаний. Их проект получил признание за высокую степень автоматизации и удобство в использовании."
      }
    ],
    2019: [
      {
    ...
    2021: [
      {
        category: "Лучший разработчик программного обеспечения (Best Software Developer)",
        name: "Богдан Паньковский",
        country: "Украина",
        project: "Система автоматизации производства",
        achievements: "Богдан разработал передовую систему для комплексной автоматизации производственных процессов для предприятий машиностроительного сектора."
      },
      {
        category: "Лучший специалист по базам данных (Best Database Specialist)",
