        ...
        <div className="why-choose-us-content">
          <div className="why-choose-us-items">
            ...
            <div className="why-choose-us-item">
              ...
              <p className="why-choose-us-item-description">Этот чемпионат предназначен исключительно для выдающихся IT-специалистов с опытом работы не менее трех лет, что гарантирует высокий уровень квалификации и профессионализма среди участников. Это создает уникальную среду для обмена передовыми знаниями и опытом.</p>
              </div>
            </div>
          </div>
        </div>
